...
function main() {
    ...
    let xzPlaneVertices = setXZPlaneVertices();
    let xzPlaneColors = setXZPlaneColors();
    ...
    function render() {
        ...
        drawXZPlane(VertexBuffer, ColorBuffer, xzPlaneVertices, xzPlaneColors, gl, positionLocation, colorLocation, modelViewMatrix, viewingMatrix, projectionMatrix, modelViewMatrixUniformLocation, viewingMatrixUniformLocation, projectionMatrixUniformLocation, theta, tx, ty, tz);
